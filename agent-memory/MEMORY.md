...
- [Propagation walk nested cascade cost](propagation-walk-nested-cascade-cost.md) — 2026-09-16: Q3-Aug COL save rewrote 26 objects 54 times (D 91 subtree x3) via per-method nested walks; index rebuild per nested walk fixed with a walk-scoped snapshot; audit_log event_dates give the exact sequence
