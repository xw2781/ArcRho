...
- [Propagation walk nested cascade cost](propagation-walk-nested-cascade-cost.md) — 2026-09-16: each method refresh runs its own nested walk and rebuilds the class index; popup/log name only top-level waves; logs never name the project
