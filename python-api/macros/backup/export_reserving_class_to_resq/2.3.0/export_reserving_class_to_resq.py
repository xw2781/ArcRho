...
# Version: 2.3.0
# Release Note: A DFM is no longer skipped over the empty average rows ResQ reports past the end of its own list, and an average named below the repeated User Entry rows can be selected again.
