...
# Version: 1.0.1
# Release Note: Keep active imports alive and reduce synchronous progress updates.
...
def run_macro(active_dfm=None, active_context=None):
    ...
    try:
        progress = ui.progress_bar(
            ...
            title="Import ResQ Reserving Class",
            label="Preparing ResQ reserving-class import",
        )
    except Exception:
        progress = None
    ...
    try:
        ...
        result = migration.import_reserving_class_from_resq(
            project_name,
            rc_path,
