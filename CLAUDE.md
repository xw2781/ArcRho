...
Include every file: code, documentation, tests, configuration, release notes, and generated output. If the task changed nothing, write `Changed files: none` on a line of its own, with a blank line above it, instead of an empty table.
