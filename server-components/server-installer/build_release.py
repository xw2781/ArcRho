...
SERVER_COMPONENTS_ROOT = INSTALLER_DIR.parent
REPOSITORY_ROOT = SERVER_COMPONENTS_ROOT.parent
SOURCE_ROOT = SERVER_COMPONENTS_ROOT / "src"
...
def component_dist_dir(role: str, app_name: str) -> Path:
    return SERVER_COMPONENTS_ROOT / "builds" / f"arcrho_{role}" / "dist" / app_name
