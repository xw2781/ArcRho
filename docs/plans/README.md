...
| [generated_formula_dependency_refresh.md](generated_formula_dependency_refresh.md) | Investigated 2026-09-05; broken into 7 session-sized steps on 2026-09-11 covering the shared formula graph, sidecar links, the scoped Engine refresh, the Project Instance Dependency Graph window, and a one-off script that fixes the existing projects; 1 of 7 done, the one shared reader of a dataset-type formula landed 2026-09-12. |
