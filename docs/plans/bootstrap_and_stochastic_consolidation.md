...
**Do.**
- [ ] Read ResQ's `MP+PIP` `F 25` over COM on the Server PC (named getters only) and pin where 1.0018 comes from: the Ratios-tab tail, a curve, or a user entry.
