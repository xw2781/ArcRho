...
contextBridge.exposeInMainWorld("ADAHost", {
  ...
  loadDfmRatioColorPreferences: () => invoke("dfm-ratio-colors-preferences-load"),
  saveDfmRatioColorPreferences: (preferences) => invoke("dfm-ratio-colors-preferences-save", { preferences }),
