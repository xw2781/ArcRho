...
FRONTEND_DOC_META: Mapping[str, Dict[str, object]] = {
    ...
    "project_instance": {
        ...
        "files": [
            ...
            ("ui/project_instance/excel_links_window.js", "Excel link inventory, workbook retargeting, and the recalculation choice."),
    ...
    "arcode": {
        ...
        "files": [
            ...
            ("ui/arcode/shared/sql_console.js", "Shared SQL console runtime: editor, connection picker, results grid, format, and ArcBot bridge."),
            ("ui/arcode/shared/sql_console.css", "Shared SQL console toolbar, meta bar, editor, and results styling."),
            ("ui/arcode/snowflake-console/index.html", "Snowflake connection, formatting, and query toolbar layout."),
            ("ui/arcode/snowflake-console/index.js", "Snowflake engine descriptor for the shared SQL console."),
            ("ui/arcode/sql-server-console/index.html", "SQL Server toolbar, meta bar, and connection manager dialog layout."),
            ("ui/arcode/sql-server-console/index.js", "SQL Server engine descriptor for the shared SQL console."),
            ("ui/arcode/sql-server-console/connections.js", "SQL Server connection profile add, edit, rename, default, and remove behavior."),
...
BACKEND_DOMAIN_META: Mapping[str, Dict[str, object]] = {
    ...
    "sql_server": {
        ...
        "files": [
            ("app_server/api/sql_server_router.py", "SQL Server connection, test, and query routes."),
            ...
            ("ui/arcode/sql-server-console/index.js", "Arcode SQL Server editor client."),
            ("ui/arcode/sql-server-console/connections.js", "Arcode SQL Server connection manager client."),
        ],
    },
    "sql_formatting": {
