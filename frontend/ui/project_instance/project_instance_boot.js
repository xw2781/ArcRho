...
import { createProjectInstanceContext } from "./project_instance_context.js?v=20260611b";
...
import { installProjectInstanceDatasetCache } from "./project_instance_dataset_cache.js?v=20260611b";
import { installProjectInstanceDatasetTable } from "./project_instance_dataset_table.js?v=20260617a";
...
import { installProjectInstanceWindows } from "./project_instance_windows.js?v=20260617a";
import { installProjectInstanceHiddenTabs } from "./project_instance_hidden_tabs.js?v=20260607d";
import { installProjectInstanceMessages } from "./project_instance_messages.js?v=20260617a";
