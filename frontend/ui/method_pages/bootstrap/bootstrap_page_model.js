...
/* The header chip. A run exists once a summary is stored; any unsaved edit
   means the stored run no longer describes the inputs on screen. */
export function bootstrapRunState({ method, dirty }) {
