...
test("the startup splash mirrors the renderer-derived persisted theme without changing Light defaults", () => {
  ...
  assert.match(splash, /\.\/shared\/styles\/themes\/dark\.css\?v=20260824e/);
...
test("DFM Ratios dark mode keeps exclusions visible and selected averages restrained", () => {
  ...
  assert.match(dfm, /themes\/dark\.css\?v=20260824e/);
});

test("changed theme and chart owners are reached through current cache-version chains", () => {
  const expectedReferences = [
    ["../ui/dataset_viewer/dataset_viewer.html", "dataset_viewer_main.js?v=20260828a"],
    ["../ui/dataset_viewer/dataset_viewer_main.js", "dataset_viewer_view.js?v=20260824c"],
    ...
    ["../ui/method_pages/bornhuetter_ferguson/bornhuetter_ferguson.html", "bornhuetter_ferguson_main.js?v=20260824e"],
    ["../ui/method_pages/cape_cod/cape_cod.html", "cape_cod_main.js?v=20260824e"],
    ["../ui/method_pages/result_selection/result_selection.html", "result_selection_main.js?v=20260824e"],
    ["../ui/method_pages/dfm/dfm.html", "dfm_main.js?v=20260824e"],
    ["../ui/project_settings/project_settings.html", "project_settings.js?v=20260824a"],
    ["../ui/project_settings/project_settings.js", "project_settings_dataset_types.js?v=20260824a"],
