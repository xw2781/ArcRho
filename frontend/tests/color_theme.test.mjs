...
test("changed theme and chart owners are reached through current cache-version chains", () => {
  const expectedReferences = [
    ["../ui/dataset_viewer/dataset_viewer.html", "dataset_viewer_main.js?v=20260923a"],
    ["../ui/dataset_viewer/dataset_viewer_main.js", "dataset_viewer_view.js?v=20260917a"],
    ...
    ["../ui/method_pages/bornhuetter_ferguson/bornhuetter_ferguson.html", "bornhuetter_ferguson_main.js?v=20260913a"],
    ["../ui/method_pages/cape_cod/cape_cod.html", "cape_cod_main.js?v=20260913a"],
    ["../ui/method_pages/result_selection/result_selection.html", "result_selection_main.js?v=20260916b"],
    ["../ui/method_pages/dfm/dfm.html", "dfm_main.js?v=20260923b"],
...
test("large page styles are maintained as feature CSS instead of inline blocks", () => {
  const extractedPages = [
    ...
    ["../ui/method_pages/bootstrap/bootstrap.html", "/ui/method_pages/bootstrap/bootstrap.css"],
    ["../ui/method_pages/stochastic_consolidation/stochastic_consolidation.html", "/ui/method_pages/stochastic_consolidation/stochastic_consolidation.css"],
