...
test("DSV and DFM reach the current shared Data validation runtime", async () => {
  ...
  assert.match(datasetHtml, /dataset_viewer_main\.js\?v=20260816a/u);
  assert.match(datasetMain, /data_tab_controller\.js\?v=20260814b/u);
  assert.match(dfmHtml, /dfm_data_tab_adapter\.js\?v=20260814b/u);
  assert.match(dfmAdapter, /data_tab_controller\.js\?v=20260814b/u);
  assert.match(dataController, /data_tab_controls\.js\?v=20260811c/u);
