...
test("DSV and DFM reach the current shared Data validation runtime", async () => {
  ...
  assert.match(datasetHtml, /dataset_viewer_main\.js\?v=20260805a/u);
  assert.match(datasetMain, /data_tab_controller\.js\?v=20260805a/u);
  assert.match(dfmHtml, /dfm_data_tab_adapter\.js\?v=20260805a/u);
  assert.match(dfmAdapter, /data_tab_controller\.js\?v=20260805a/u);
