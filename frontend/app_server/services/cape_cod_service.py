...
def refresh_output(
    ...
    """Republish one Cape Cod output and report instead of raising.
    ...
    sidecar_cache = dependent_walk_service.walk_cache(caches, "cape_cod_sidecars")
    snapshot_cache = dependent_walk_service.walk_cache(
        caches, "cape_cod_source_snapshots"
    )
...
def refresh_dependents(
    ...
    *,
    ...
    """Refresh what these datasets reach and report the Cape Cod part of it.
