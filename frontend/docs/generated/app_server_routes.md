...
| `bootstrap` | `app_server/api/bootstrap_router.py` | 6 | [Open Domain Index](../app_server/domains/bootstrap.md) |
...
| `dataset` | `app_server/api/dataset_router.py` | 20 | [Open Domain Index](../app_server/domains/dataset.md) |
...
| `excel_link` | `app_server/api/excel_link_router.py` | 8 | [Open Domain Index](../app_server/domains/excel_link.md) |
...
| `reserving_class` | `app_server/api/reserving_class_router.py` | 12 | [Open Domain Index](../app_server/domains/reserving_class.md) |
...
| `stochastic_consolidation` | `app_server/api/stochastic_consolidation_router.py` | 5 | [Open Domain Index](../app_server/domains/stochastic_consolidation.md) |
...
| Method | Path | Handler | Request Model | Schema | Service Calls |
| --- | --- | --- | --- | --- | --- |
| `POST` | `/excel_links/break` | `excel_links_break` | `ExcelLinkBreakRequest` | [`app_server/schemas/excel_link.py`](../../app_server/schemas/excel_link.py) | `engine_hosted_save_service.run_hosted_save` |
| `POST` | `/excel_links/break/plan` | `plan_excel_links_break` | `ExcelLinkBreakRequest` | [`app_server/schemas/excel_link.py`](../../app_server/schemas/excel_link.py) | `engine_hosted_save_service.run_hosted_save_plan` |
| `POST` | `/excel_links/check` | `excel_links_check` | `ExcelLinkListRequest` | [`app_server/schemas/excel_link.py`](../../app_server/schemas/excel_link.py) | - |
| `POST` | `/excel_links/list` | `excel_links_list` | `ExcelLinkListRequest` | [`app_server/schemas/excel_link.py`](../../app_server/schemas/excel_link.py) | - |
| `POST` | `/excel_links/refresh` | `excel_links_refresh` | `ExcelLinkRefreshRequest` | [`app_server/schemas/excel_link.py`](../../app_server/schemas/excel_link.py) | `engine_hosted_save_service.run_hosted_save` |
| `POST` | `/excel_links/refresh/plan` | `plan_excel_links_refresh` | `ExcelLinkRefreshRequest` | [`app_server/schemas/excel_link.py`](../../app_server/schemas/excel_link.py) | `engine_hosted_save_service.run_hosted_save_plan` |
