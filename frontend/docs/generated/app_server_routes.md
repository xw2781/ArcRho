...
| `project_settings` | `app_server/api/project_settings_router.py` | 12 | [Open Domain Index](../app_server/domains/project_settings.md) |
...
| `ui_automation` | `app_server/api/ui_automation_router.py` | 3 | [Open Domain Index](../app_server/domains/ui_automation.md) |
