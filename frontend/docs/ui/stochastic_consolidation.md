...
- `ui/method_pages/stochastic_consolidation/stochastic_consolidation.html`: external scripts `/ui/method_pages/stochastic_consolidation/stochastic_consolidation_main.js?v=20260924d`, `/ui/shared/services/color_theme.js?v=20260923c`, `/ui/shared/tabbed_page/initial_tab_paint.js?v=20260824d`; inline imports _none_.
