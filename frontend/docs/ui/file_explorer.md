...
- `ui/file_explorer/file_explorer.html`: external scripts `/ui/file_explorer/file_explorer.js?v=20260808a`, `/ui/shared/services/color_theme.js?v=20260923c`; inline imports _none_.
