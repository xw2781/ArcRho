...
- `ui/arcode/main.html`: external scripts `/ui/arcode/main.js?v=20260909a`, `/ui/shared/services/color_theme.js?v=20260923c`; inline imports _none_.
...
- `ui/arcode/code-editor/index.html`: external scripts `/ui/arcode/code-editor/index.js?v=20260818a`, `/ui/arcode/shared/editor_shared.js?v=20260620a`, `/ui/arcode/shared/zoom_bridge.js?v=20260614a`, `/ui/libs/monaco-editor/min/vs/loader.js`, `/ui/shared/services/color_theme.js?v=20260923c`; inline imports _none_.
