...
- `ui/project_settings/project_settings.html`: external scripts `/ui/project_settings/project_settings.js?v=20260722a`, `/ui/shared/services/color_theme.js?v=20260723a`; inline imports _none_.
