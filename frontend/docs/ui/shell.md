...
- `ui/index.html`: external scripts `/ui/shell/ui_shell.js?v=20260620a`; inline imports _none_.
...
- Arcode owns scripting recent files and notebook/file tab behavior; the ArcRho shell no longer creates new in-shell Scripting Console tabs.
