...
- Settings > Clear Cache & Reload is also available through Alt+Q; the shortcut is handled as a shell command even when focus is inside a top-level feature iframe.
