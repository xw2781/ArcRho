...
- `ui/method_pages/cape_cod/cape_cod.html`: external scripts `/ui/method_pages/cape_cod/cape_cod_main.js?v=20260807b`, `/ui/shared/services/color_theme.js?v=20260811a`; inline imports _none_.
