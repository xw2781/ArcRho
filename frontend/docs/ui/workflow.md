...
- `ui/workflow/workflow.html`: external scripts `/ui/shared/services/color_theme.js?v=20260811a`, `/ui/workflow/workflow_main.js?v=20260726a`; inline imports _none_.
