...
| --- | --- | --- | --- | --- | --- |
| `POST` | `/excel_links/list` | `excel_links_list` | `ExcelLinkListRequest` | [`app_server/schemas/excel_link.py`](../../../app_server/schemas/excel_link.py) | `excel_link_service.list_reserving_class_excel_links` |
